	!Programa que calcula a trajetória de um projétil considerando resistencia do ar, altura e velocidade. 

	program projetil_resistente
	IMPLICIT NONE
	...
	end program projetil_resistente
