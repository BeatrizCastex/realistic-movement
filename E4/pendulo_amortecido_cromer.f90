! Programa que calcula o ângulo em função do tempo de um pêndulo amortecido e influênciado por uma forç externa na vertival pelo método de Euler-Cromer

	program pendulo_amortecido_cromer
	IMPLICIT NONE
	...
	open(32,file = "pendulo_amortecido_cromer_01.dat")
	!Arquivo para quando dt = 0.0001
	!open(33,file = "pendulo_amortecido_cromer_0001.dat")
	...
	end program pendulo_amortecido_cromer